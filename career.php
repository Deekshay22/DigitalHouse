...
<div class="infocc">
  <div class="career-coninfo-form-container" career-coninfo>
    <h2>Contact Us</h2>
    <form class="career-INfo">
      <div class="form-group">
        <label for="career-coninfo-name">Name</label>
        <input type="text" class="form-control" id="career-coninfo-name" placeholder="Enter your name" required>
      </div>
      <div class="form-group">
        <label for="career-coninfo-email">Email</label>
        <input type="email" class="form-control" id="career-coninfo-email" placeholder="Enter your email" required>
      </div>
      <div class="form-group">
        <label for="career-coninfo-phone">Phone</label>
        <input type="tel" class="form-control" id="career-coninfo-phone" placeholder="Enter your phone number">
      </div>
      <div class="form-group">
        <label for="career-coninfo-message">Upload resume</label>
        <input type="file" class="form-control" id="career-coninfo-message" rows="4" placeholder="Write your message here"></textarea>
      </div>
      <br>

            ...
            <div class="col-lg-4 col-md-8">
                <div class="our-testimonial-content">
                    <div class="section-title">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay="0.25s">What our <span>Client Say About Us</span></h2>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="testimonial-slider-content">
                                        <div class="testimonial-header">
                                            <div class="testimonial-rating-company">
                                                <img src="assets/images/icon-testimonial-rating-4.svg" alt="The Digital House, Currency Tower, Raipur">
                                            </div>
                                            <div class="testimonial-quote">
                                                <img src="assets/images/testimonial-quote.svg" alt="The Digital House, Currency Tower, Raipur">
                                            </div>
                                        </div>
            ...
            <!-- <div class="col-lg-12">
                <div class="testimonial-rating-box">
                    <div class="testimonial-rating-item">
                        <div class="icon-box">
                            <img src="assets/images/icon-testimonial-rating-1.svg" alt="The Digital House, Currency Tower, Raipur">
                        </div>
                        <div class="testimonial-rating-content">
                            <p><span class="counter">982</span>+ Trustpilot 4.8 start reviews</p>
                        </div>
                    </div>

                    <div class="testimonial-rating-item">
                        <div class="icon-box">
                            <img src="assets/images/icon-testimonial-rating-2.svg" alt="The Digital House, Currency Tower, Raipur">
                        </div>
                        <div class="testimonial-rating-content">
                    ...
                    <div class="testimonial-rating-item">
                        <div class="icon-box">
                            <img src="assets/images/icon-testimonial-rating-3.svg" alt="The Digital House, Currency Tower, Raipur">
                        </div>
                        <div class="testimonial-rating-content">

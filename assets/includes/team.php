...
<div class="container my-5">
    <div class="team-container"  class="image-anime" team>
        <div class="team-card yellow">
            <img src="avatar-placeholder.png" alt="Dyna">
            <h3>Chaitanya Sahu</h3>
            <p>UI/UX Designer</p>
        </div>
        <div class="team-card gray">
            <img src="assets/images/team/Aman.jpg" alt="Sydney">
            <h3>Aman Sahu</h3>
            <p>Head Video Editor</p>
        </div>
        <div class="team-card blue">
            <img src="avatar-placeholder.png" alt="Stephani">
            <h3>Sudipta Dutta Roy</h3>
            <p>Content Writer</p>
        </div>
        <div class="team-card pink">
            <img src="assets/images/team/Himanshii.jpg" alt="Rachel">
            <h3>Himanshi Shadija</h3>
            <p>Motion Graphic Editor</p>
        </div>
        <div class="team-card green">
            <img src="assets/images/team/Deeksha.png" alt="Alex">
            <h3>Deeksha Yadav</h3>
            <p> Web Developer</p>
        </div>
        <h1></h1>
